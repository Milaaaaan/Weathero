...
})({"5xJc0":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6c69bc246bcafc66";
...
},{}],"3S3Lw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _coordinatesJs = require("../modules/coordinates.js");
var _initializeJs = require("../modules/initialize.js");
var _getWeatherJs = require("../modules/getWeather.js");
...
if (localStorage.getItem('initialized') === "0") {
    console.log(true);
    _coordinatesJs.getOwnCoords();
    localStorage.setItem('initialized', "1");
}
const daytrip = async function() {
    try {
        await _initializeJs.innit();
        await _getWeatherJs.getDataDay();
    } catch (err) {
        console.log(err);
    } finally{
        await graph();
...
},{"../modules/coordinates.js":"6vOWn","../modules/initialize.js":"cWnVy","../modules/getWeather.js":"h2WzH","chart.js/auto":"6r6LS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6vOWn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "lat", ()=>lat
);
parcelHelpers.export(exports, "lon", ()=>lon
);
parcelHelpers.export(exports, "getOwnCoords", ()=>getOwnCoords
);
parcelHelpers.export(exports, "getNewCoords", ()=>getNewCoords
);
"use strict";
...
let country;
let city;
const getOwnCoords = function() {
    if (navigator.geolocation) navigator.geolocation.getCurrentPosition((position)=>{
        lat = position.coords.latitude;
        lon = position.coords.longitude;
        localStorage.setItem('lat', lat);
        localStorage.setItem('lon', lon);
        fetch("http://api.openweathermap.org/geo/1.0/reverse?lat=" + lat + "&lon=" + lon + "&limit=5&appid=32170ef0fc72596dcaae2034ea56b418").then((response)=>response.json()
        ).then((data)=>{
    ...
    else console.log("brower does not support");
};
const getNewCoords = function() {
    fetch("http://api.openweathermap.org/geo/1.0/direct?q=" + document.querySelector('input').value + "&limit=5&appid=" + localStorage.getItem('API_key')).then((response)=>response.json()
    ).then((data)=>{
        console.log(data);
...
},{}],"cWnVy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "innit", ()=>innit
);
parcelHelpers.export(exports, "API", ()=>API
);
parcelHelpers.export(exports, "API_URL", ()=>API_URL
);
parcelHelpers.export(exports, "blockHour", ()=>blockHour
);
parcelHelpers.export(exports, "blockDay", ()=>blockDay
);
...
parcelHelpers.export(exports, "tempNight", ()=>tempNight
);
...
const innit = function() {
    document.querySelector('.location').innerHTML = localStorage.getItem('state') + localStorage.getItem('city');
    localStorage.setItem('API_URL', "https://api.openweathermap.org/data/2.5/onecall?lat=" + _coordinatesJs.lat + "&lon=" + _coordinatesJs.lon + "&exclude=minutely&appid=" + localStorage.getItem('API_key') + "&units=metric");
};
...
},{"./coordinates.js":"6vOWn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h2WzH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getDataDay", ()=>getDataDay
);
parcelHelpers.export(exports, "getDataHour", ()=>getDataHour
);
parcelHelpers.export(exports, "tempArr", ()=>tempArr
);
...
let tempArrNight = [];
let windArr = [];
const getDataDay = function() {
    fetch(localStorage.getItem('API_URL')).then((response)=>response.json()
    ).then((data)=>{
        console.log(data);
        let date = new Date(_initializeJs.dt);
        ...
        for(let i = 0; i < _initializeJs.blockDay.length; i++){
            let date = new Date(_initializeJs.dt);
            ...
            _initializeJs.temp[i].textContent = parseInt(data.daily[i].temp.day) + "°C";
            _initializeJs.tempNight[i].textContent = parseInt(data.daily[i].temp.night) + "°C";
            _initializeJs.day[i].textContent = _initializeJs.weekday[date.getDay()] + "";
            _initializeJs.img[i].src = getImg(data.daily[i].weather[0].id, false);
        }
        const tmpChart = document.getElementById('tempChart');
        const wndChart = document.getElementById('windChart');
        const myChart = new _autoDefault.default(tmpChart, {
            type: 'bar',
            data: {
                labels: _initializeJs.weekday,
                datasets: [
                    {
                        label: 'Day °C',
                        data: tempArrDay,
        ...
        const tempChart = new _autoDefault.default(wndChart, {
            type: 'line',
            data: {
                labels: _initializeJs.weekday,
                datasets: [
...
const getDataHour = function() {
    fetch(localStorage.getItem('API_URL')).then((response)=>response.json()
        ...
        document.querySelector('.top img').src = "../" + getImg(data.hourly[0].weather[0].id);
        document.querySelector('h3').textContent = data.hourly[0].weather[0].description + "";
        for(let i = 0; i < _initializeJs.blockHour.length; i++){
            let date = new Date(_initializeJs.dt);
            date.setHours(date.getHours() + parseInt((data.hourly[i].dt + data.timezone_offset) / 3600));
            _initializeJs.temp[i].textContent = parseInt(data.hourly[i].temp) + "°C";
            _initializeJs.time[i].textContent = date.getHours() + ":00";
            _initializeJs.day[i].textContent = _initializeJs.weekday[date.getDay()] + "";
            _initializeJs.img[i].src = "../" + getImg(data.hourly[i].weather[0].id, date.getHours() >= 0 && date.getHours() < 6);
        }
        let date = new Date(_initializeJs.dt);
        ...
        for(let i1 = 1; i1 < 5; i1++){
            ...
            label[i1].label = _initializeJs.weekday[date.getDay()] + "-" + date.getHours() + ":00";
        }
    });
};
function getImg(id, night) {
    if (id >= 200 && id <= 202 || id >= 230 && id <= 232) {
        if (night) return "Include/img/rain/thunderstorms-night-rain.scg";
        return "Include/img/rain/thunderstorms-day-rain.scg";
    } else if (id >= 210 && id <= 221) {
        if (night) return "Include/img/rain/thunderstorms-night.scg";
        return "Include/img/rain/thunderstorms-day.scg";
    } else if (id >= 300 && id <= 321) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-drizzle.svg";
        return "Include/img/cloudness/partly-cloudy-day-drizzle.svg";
    } else if (id >= 500 && id <= 531) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-rain.svg";
        return "Include/img/cloudness/partly-cloudy-day-rain.svg";
    } else if (id >= 600 && id <= 622) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-snow.svg";
        return "Include/img/cloudness/partly-cloudy-day-snow.svg";
    } else if (id === 701 || id === 41) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-fog.svg";
        return "Include/img/cloudness/partly-cloudy-day-fog.svg";
    } else if (id === 711 || id === 731 || id === 751 || id === 761 || id === 762) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-smoke.svg";
        return "Include/img/cloudness/partly-cloudy-day-smoke.svg";
    } else if (id === 721) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-haze.svg";
        return "Include/img/cloudness/partly-cloudy-day-haze.svg";
    } else if (id === 771 || id === 781) {
        if (night) return "Include/img/cloudness/partly-cloudy-night-fog.svg";
        return "Include/img/cloudness/partly-cloudy-day-fog.svg";
    } else if (id === 800) {
        if (night) return "Include/img/cloudness/clear-night.svg";
        return "Include/img/cloudness/clear-day.svg";
    } else if (id >= 801 && id <= 802) {
        if (night) return "Include/img/cloudness/partly-cloudy-night.svg";
        return "Include/img/cloudness/partly-cloudy-day.svg";
    } else if (id >= 803 && id <= 804) {
        if (night) return "Include/img/cloudness/overcast-night.svg";
        return "Include/img/cloudness/overcast-day.svg";
    }
}

},{"./initialize.js":"cWnVy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","chart.js/auto":"6r6LS"}],"6r6LS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5xJc0","3S3Lw"], "3S3Lw", "parcelRequire94c2")

//# sourceMappingURL=index.6bcafc66.js.map
